...
(function () {
  ...
  const PRODUCT_ICON_RULES = [
    ...
    { match: "mexican groceries", icon: "🇲🇽", label: "Mexican Groceries" },
    { match: "latin american", icon: "🌎", label: "Latin American Goods" },
    { match: "central american", icon: "🌎", label: "Central American Goods" },
    { match: "south american", icon: "🌎", label: "South American Goods" },
    { match: "caribbean", icon: "🏝️", label: "Caribbean Goods" },
    { match: "jamaican", icon: "🇯🇲", label: "Jamaican Goods" },
    { match: "haitian", icon: "🇭🇹", label: "Haitian Goods" },
    { match: "trinidad", icon: "🇹🇹", label: "Trinidadian Goods" },
    { match: "african", icon: "🌍", label: "African Goods" },
    { match: "filipino", icon: "🇵🇭", label: "Filipino Goods" },
    { match: "brazilian", icon: "🇧🇷", label: "Brazilian Goods" },
    { match: "portuguese", icon: "🇵🇹", label: "Portuguese Goods" },
    { match: "eastern european", icon: "🇪🇺", label: "Eastern European Goods" },
    { match: "german", icon: "🇩🇪", label: "German Goods" },
    { match: "irish", icon: "🇮🇪", label: "Irish Goods" },
    { match: "scottish", icon: "🏴󠁧󠁢󠁳󠁣󠁴󠁿", label: "Scottish Goods" },
    { match: "celtic", icon: "☘️", label: "Celtic Goods" },
    { match: "asian", icon: "🥢", label: "Asian Goods" },
    { match: "tortilla", icon: "🫓", label: "Tortillas" },
    { match: "masa", icon: "🌽", label: "Masa" },
    { match: "chile", icon: "🌶️", label: "Chiles" },
    { match: "spice", icon: "🧂", label: "Spices" },
    { match: "plantain", icon: "🍌", label: "Plantains" },
    { match: "yuca", icon: "🥔", label: "Yuca" },
    { match: "sofrito", icon: "🧄", label: "Sofrito" },
    { match: "ube", icon: "🍠", label: "Ube" },
    { match: "picanha", icon: "🥩", label: "Picanha" },
    { match: "ramen", icon: "🍜", label: "Ramen" },
    { match: "noodle", icon: "🍜", label: "Noodles" },
    { match: "dumpling", icon: "🥟", label: "Dumplings" },
    { match: "tofu", icon: "🧈", label: "Tofu" },
    { match: "kimchi", icon: "🥬", label: "Kimchi" },
    { match: "gochujang", icon: "🌶️", label: "Gochujang" },
    { match: "sweetgrass", icon: "🧺", label: "Sweetgrass" },
    { match: "gullah", icon: "🪘", label: "Gullah-Geechee Foodways" },
    { match: "banger", icon: "🌭", label: "Bangers" },
    { match: "shortbread", icon: "🍪", label: "Shortbread" },
    { match: "sauerkraut", icon: "🥬", label: "Sauerkraut" },
    { match: "mustard", icon: "🟡", label: "Mustard" },
  ...
  const DISTANCE_RULES = [
    ...
    { pattern: /\bhinesville\b/i, miles: 68 },
    { pattern: /\bawendaw\b/i, miles: 90 },
